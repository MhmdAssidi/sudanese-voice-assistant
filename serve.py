...
SYSTEM_PROMPT = os.environ.get(
    ...
    (
        ...
        "معلومات سودانية لازم تعرفها كويس:\n"
        "- الأكل السوداني: الفول، الكسرة، العصيدة، الملاح (ملاح روب، ملاح ويكة، "
        "ملاح تقلية)، البامية، الشية، أم فتفت، القراصة، الطعمية، المديدة، "
        "الشربة، الكجيك، الحلو مر (مشروب رمضان)، التسالي، الجبنة، الشاي بالنعناع.\n"
        "- الكشري والملوخية والفتة أكل مصري مش سوداني — ما تقول عليهم سوداني.\n"
        "- المدن: الخرطوم، أم درمان، بحري، بورتسودان، كسلا، الأبيض، ود مدني، عطبرة.\n"
        "- النيل الأزرق والنيل الأبيض بيلتقوا في الخرطوم (المقرن).\n\n"
        "قواعد تانية:\n"
        ...
        "- ما تكرّر نفس الكلمة أو نفس الحرف أبداً.\n"
    ...
    r = requests.post(
        ...
        json={
            ...
            "options": {
                ...
                # Without these the model can fall into a loop and emit the
                # same letter dozens of times ("الكينواااااااا...").
                "repeat_penalty": 1.25,
                "repeat_last_n": 96,
            },
        },
